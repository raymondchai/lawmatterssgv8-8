                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={handleChange}
                        placeholder="Legal matter subject"
                      />
                    </div>
                  </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+65 6765 4321</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@lawmatters.sg</p>
                    <p className="text-gray-600">consultation@lawmatters.sg</p>
                  </div>
                </div>
              </CardContent>
            </Card>
